...
class TLSContext:
    def __init__(self, peer_name):
        # which party of the TLS communication is being referred to
        assert peer_name in ('client', 'server')
        self.peer_name = peer_name
        # Store the messages sent in the TLS exchange.
        # The dictionary key is the class name (such as ClientHello),
        # and the value is an instance of the TLSPlaintext class.
        self.tls_messages = {}
        # The byte array of the record.
        # fragment section in the Handshake record has been concatenated.
